    ...
    <>
      <RadixDialog.Root open={open} onOpenChange={(next) => !next && onClose()}>
        <RadixDialog.Portal>
          ...
          <RadixDialog.Content className="fixed left-1/2 top-1/2 z-50 w-[600px] max-h-[85vh] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-lg border border-line bg-bg-canvas shadow-popover animate-fade-in flex flex-col">
